    ...
    return (
        <div className="footer-bg">
                ...
                <Row className="text-white">
                    ...
                    <Col xs={6} md={3}>
                        <div className="single-footer-widget">
                            ...
                            <div className="widget-content">
                                <NavLink className="footer-link">Datobbo Dentistry 566 Keen </NavLink>
                                <NavLink className="footer-link">Village Dr Chudail, IN.</NavLink>
                                <NavLink className="footer-link">Phone:+91 5555420420</NavLink>
            ...
            <div className="footer-copy-right text-center text-white">
                <p className='mb-0'>&copy; 2023 - <span className="developer">Malvica</span> | All Rights Reserved</p>
            </div>
        </div>
    );
};
